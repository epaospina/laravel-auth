...
<html lang="es">
    ...
    <body itemscope itemtype="http://schema.org/WebPage">
        ...
        <div class="mcv-container" style="padding:128px 16px" id="about">
            ...
            <div class="mcv-row-padding mcv-center" style="margin-top:64px">
                <div class="mcv-quarter">
                    <p class="mcv-large">TRANSPORTE SEGURO</p>
                    <p>
                ...
                <div class="mcv-quarter">
                    <p class="mcv-large">TRATO PERSONALIZADO</p>
                ...
                <div class="mcv-quarter">
                    <p class="mcv-large">NUESTROS CLIENTES</p>
                ...
                <div class="mcv-quarter">
                    <p class="mcv-large">NUESTRA FLOTA</p>
        ...
        <div class="mcv-container" style="padding:128px 16px" id="work">
            <h3 class="mcv-center">NUESTRA FLOTA</h3>
